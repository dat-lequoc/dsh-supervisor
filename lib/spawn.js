  ...
  ctx.systemPrompt.section({
    ...
    text: () => {
      ...
      const lines = [
        ...
        ...current === undefined ? [] : [
          `- Timing defaults: wakeMinutes=${current.wakeMinutes}, questionWaitMinutes=${current.questionWaitMinutes}. A workspace's .agi/config.json overrides them when it carries the key.`,
        ],
      ]
      return lines.join('\n')
    },
