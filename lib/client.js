...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /** Number input bound to one staged field. */
    function NumberRow(props) {
      return h('label', { style: { display: 'flex', alignItems: 'center', gap: 10, fontSize: 13, color: palette.text } },
        ...
        h('span', { style: { fontSize: 11, color: palette.dim } }, props.hint ?? ''))
    }
