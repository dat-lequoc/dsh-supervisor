...
const SettingsSchema = z.object({
  ...
  /** Worker reasoning policy: current turn, provider default, or one opaque
   * effort id advertised by the selected route's native model catalog. */
  workerEffort: z.string().default(WORKER_EFFORT_CURRENT),
...
const SETTINGS_DEFAULTS = {
  ...
  workerEffort: WORKER_EFFORT_CURRENT,
